...
public class Card : MonoBehaviour 
{
	...
	public void D_MoveCard(GameObject CardObject,Vector3 v,string MyPC,string OUT)
	{
		ResetD_RotateCard(CardObject);
		ResetD_MoveCard(CardObject);
		//waitTime(10);
		MoveD_Rotate(CardObject,MyPC,OUT);
		D_Move(CardObject,v);
	...
	public void MoveD_Rotate(GameObject CardObject,string My,string OUT)
	{
		Card info = CardObject.GetComponent<Card>();
		Vector3 v;
